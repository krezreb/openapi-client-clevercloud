...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.authorize_form  # this is an instance of the class Endpoint
        api_instance.authorize_form()  # this invokes api_instance.authorize_form.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.authorize_form.callable or self.callable in this class
